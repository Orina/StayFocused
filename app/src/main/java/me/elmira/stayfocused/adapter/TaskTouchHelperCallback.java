...
public class TaskTouchHelperCallback extends ItemTouchHelper.Callback {
    ...
    private static final String LOG_TAG = "TaskTouchHelperCallback";
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        ...
        if (actionState != ItemTouchHelper.ACTION_STATE_IDLE) {
            if (viewHolder instanceof TaskTouchHelperViewHolder) {
                TaskTouchHelperViewHolder itemViewHolder = (TaskTouchHelperViewHolder) viewHolder;
